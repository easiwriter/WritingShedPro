...
const requiredRouteSmokeReadinessFields = [
    ...
    "readyToRunProductionMigration",
    "readyToRunProductionApply",
...
const requiredRouteSmokeReadOnlyQueryAssertions = [
    ...
    "environmentPreflightDb.preparedStatements.length, 2",
    "blockedEnvironmentPreflightDb.preparedStatements.length, 2",
    "missingEnvironmentPreflightDb.preparedStatements.length, 2",
