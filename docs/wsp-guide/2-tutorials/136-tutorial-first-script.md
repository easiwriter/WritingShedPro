...
See **[DML Reference](../9-drama-features/84-dml-reference.md)** for every available markup option, including lyrics, sound effects, and more.
...
- **[DML Reference](../9-drama-features/84-dml-reference.md)** — Complete markup reference
- **[Film vs Stage Formats](../9-drama-features/83-film-vs-stage-formats.md)** — Detailed format comparison
- **[Drama Mode Overview](../9-drama-features/81-drama-mode-overview.md)** — Full feature reference
