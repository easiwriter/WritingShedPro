...
A project is the foundation of your writing in Writing Shed Pro. Every poem, story, script, or document lives inside a project. This guide walks you through creating and setting up your first project.
...
| **Drama** | Scripts and plays | DML formatting, film/stage output |

You can't change a project's type after creation, so choose the one that best fits your work.
...
- **Sort**: By name, date created, or custom order
