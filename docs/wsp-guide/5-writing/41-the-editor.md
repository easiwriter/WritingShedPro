...
> **Note**: Reference options appear only when the corresponding back matter section is enabled in your project's manuscript settings. See [Manuscript Structure](../4-projects/36-manuscript-structure.md) for details.
...
### Learn the Shortcuts
Keyboard shortcuts dramatically speed up your workflow. See [Keyboard Shortcuts](../12-reference/111-keyboard-shortcut-list.md).
