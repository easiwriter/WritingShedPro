...
- **Rhyme Detection**: See rhyme schemes as you write
- **Form Reference**: Quick reference for the rules of each form
- **Collections**: Group related poems together
- **Submissions**: Track where you've sent your work

See [Poetry Mode Overview](../7-poetry-features/61-poetry-mode-overview.md) for details.
...
See [Fiction Mode Overview](../8-fiction-features/71-fiction-mode-overview.md) for details.
...
See [Drama Mode Overview](../9-drama-features/81-drama-mode-overview.md) for details.
