...
/// Creates a type-specific folder structure based on the project type (Blank, Novel, Poetry, Script, Short Story).
struct ProjectTemplateService {
    ...
    /// Creates the type-specific root folder (BLANK/YOUR NOVEL/YOUR POETRY/YOUR SCRIPT/YOUR STORIES)
